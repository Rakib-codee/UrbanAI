...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] max-h-[900px] bg-[#1e293b] rounded-xl shadow-2xl border border-gray-700">
      {/* Header */}
    ...
    <div className="p-4 md:p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-1">
          Ask questions about urban planning, smart cities, and sustainable development.
        </p>
      </div>
