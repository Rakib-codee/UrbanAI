  ...
  webpack: (config, { isServer, webpack }) => {
    ...
    config.resolve = {
      ...
      alias: {
        ...
        '@/components/ui/Textarea': path.resolve(__dirname, './src/components/ui/Textarea.tsx'),
        '@/components/ui/card': path.resolve(__dirname, './src/components/ui/Card.tsx'),
        '@/components/ui/Card': path.resolve(__dirname, './src/components/ui/Card.tsx'),
        '@/components/ui/tabs': path.resolve(__dirname, './src/components/ui/Tabs.tsx'),
        '@/components/ui/Tabs': path.resolve(__dirname, './src/components/ui/Tabs.tsx'),
        '@/components/ui/switch': path.resolve(__dirname, './src/components/ui/Switch.tsx'),
        '@/components/ui/Switch': path.resolve(__dirname, './src/components/ui/Switch.tsx'),
        '@/components/ui/slider': path.resolve(__dirname, './src/components/ui/Slider.tsx'),
        '@/components/ui/Slider': path.resolve(__dirname, './src/components/ui/Slider.tsx'),
        '@/components/ui/avatar': path.resolve(__dirname, './src/components/ui/Avatar.tsx'),
        '@/components/ui/Avatar': path.resolve(__dirname, './src/components/ui/Avatar.tsx'),
        '@/components/ui/dropdown-menu': path.resolve(__dirname, './src/components/ui/DropdownMenu.tsx'),
        '@/components/ui/DropdownMenu': path.resolve(__dirname, './src/components/ui/DropdownMenu.tsx'),
